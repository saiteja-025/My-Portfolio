        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
          {projectsData.map((project, idx) => (
            <motion.div
              ...
              className="group glass rounded-3xl overflow-hidden hover:border-black/20 dark:hover:border-white/20 transition-all duration-300 flex flex-col h-full hover:shadow-xl dark:hover:shadow-none"
            >
              <Link to={`/projects/${project.id}`} className="flex flex-col grow">
                ...
                <div className="p-8 pb-4 flex flex-col grow">
              ...
              <div className="px-8 pb-8">
                <div className="flex items-center gap-4 text-sm font-bold pt-4 border-t border-black/10 dark:border-white/10 text-slate-800 dark:text-white">
                  {project.github && (
